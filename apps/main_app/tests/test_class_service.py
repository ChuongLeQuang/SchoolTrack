...
def test_get_classes_from_excel(mock_load_excel) -> None:
    ...
    classes = ClassService.get_classes_from_excel("fake_path.xlsx")
...
def test_create_academic_year_file(mock_workbook, mock_exists) -> None:
    """
...
def test_save_class_to_excel(mock_save_row) -> None:
    """
    ...
    ClassService.save_class_to_excel("fake_path.xlsx", cls)
    ...
    assert kwargs["sheet_name"] == "Danh Sach Lop"  # Phải lưu đúng vào Sheet 1
...
def test_delete_class_from_excel(mock_delete_row) -> None:
    """
    ...
    result = ClassService.delete_class_from_excel("fake_path.xlsx", "LNH0825NEA")
